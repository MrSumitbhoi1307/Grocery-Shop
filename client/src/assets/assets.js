...
import tomato_image_1 from "./tomato_image_1.png";
import tomato_image_2 from "./tomato_image_2.png";
import tomato_image_3 from "./tomato_image_3.jpg";
import tomato_image_4 from "./tomato_image_4.jpg";
import carrot_image_1 from "./carrot_image_1.png";
import carrot_image_2 from "./carrot_image_2.jpg";
import carrot_image_3 from "./carrot_image_3.jpg";
import carrot_image_4 from "./carrot_image_4.jpg";
import spinach_image_1 from "./spinach_image_1.png";
import spinach_image_2 from "./spinach_image_2.jpg";
import spinach_image_3 from "./spinach_image_3.jpg";
import spinach_image_4 from "./spinach_image_4.jpg";
import onion_image_1 from "./onion_image_1.png";
import onion_image_2 from "./onion_image_2.jpg";
import onion_image_3 from "./onion_image_3.jpg";
import onion_image_4 from "./onion_image_4.jpg";
import apple_image_1 from "./apple_image_1.png";
import apple_image_2 from "./apple_image_2.jpg";
import apple_image_3 from "./apple_image_3.jpg";
import apple_image_4 from "./apple_image_4.jpg";
import amul_milk_image_1 from "./amul_milk_image_1.png";
import amul_milk_image_2 from "./amul_milk_image_2.jpeg";
import amul_milk_image_3 from "./amul_milk_image_3.jpeg";
import amul_milk_image_4 from "./amul_milk_image_4.jpeg";
import coca_cola_image_1 from "./coca_cola_image_1.png";
import coca_cola_image_2 from "./coca_cola_image_2.jpg";
import coca_cola_image_3 from "./coca_cola_image_3.jpg";
...
import orange_image_4 from "./orange_image_4.jpg";
import pepsi_image_1 from "./pepsi_image_1.png";
import pepsi_image_2 from "./pepsi_image_2.jpg";
import pepsi_image_3 from "./pepsi_image_3.jpg";
import pepsi_image_4 from "./pepsi_image_4.jpg";
...
import banana_image_2 from "./banana_image_2.jpg";
import banana_image_3 from "./banana_image_3.jpg";
import banana_image_4 from "./banana_image_4.jpg";
import mango_image_1 from "./mango_image_1.png";
import mango_image_2 from "./mango_image_2.jpg";
import mango_image_3 from "./mango_image_3.jpg";
import mango_image_4 from "./mango_image_4.jpg";
...
import sprite_image_4 from "./sprite_image_4.jpg";
import fanta_image_1 from "./fanta_image_1.png";
import fanta_image_2 from "./fanta_image_2.jpg";
import fanta_image_3 from "./fanta_image_3.jpg";
import fanta_image_4 from "./fanta_image_4.jpg";
import seven_up_image_1 from "./seven_up_image_1.png";
import seven_up_image_2 from "./seven_up_image_2.jpg";
import seven_up_image_3 from "./seven_up_image_3.jpg";
import seven_up_image_4 from "./seven_up_image_4.jpg";
...
export const dummyProducts = [
  ...
  },
  {
    ...
    price: 40,
    offerPrice: 35,
    image: [tomato_image_1, tomato_image_2, tomato_image_3,  tomato_image_4],
    description: [
      "Juicy and ripe",
      "Rich in Vitamin C",
  ...
  },
  {
    ...
    price: 30,
    offerPrice: 28,
    image: [carrot_image_1, carrot_image_2,  carrot_image_3,  carrot_image_4  ],
    description: [
      "Sweet and crunchy",
      "Good for eyesight",
  ...
  },
  {
    ...
    price: 18,
    offerPrice: 15,
    image: [spinach_image_1,  spinach_image_2, spinach_image_3, spinach_image_4],
    description: [
      "Rich in iron",
      "High in vitamins",
  ...
  },
  {
    ...
    price: 22,
    offerPrice: 19,
    image: [onion_image_1,  onion_image_2, onion_image_3, onion_image_4],
    description: [
      "Fresh and pungent",
      "Perfect for cooking",
      "A kitchen staple",
  ...
  // Fruits
  {
    ...
    price: 120,
    offerPrice: 110,
    image: [apple_image_1,apple_image_2,apple_image_3,apple_image_4],
    description: [
      "Crisp and juicy",
      "Rich in fiber",
      "Boosts immunity",
  ...
  },
  {
    ...
    price: 80,
    offerPrice: 75,
    image: [orange_image_1,orange_image_2,orange_image_3,orange_image_4],
    description: [
      "Juicy and sweet",
      "Rich in Vitamin C",
  ...
  },
  {
    ...
    price: 50,
    offerPrice: 45,
    image: [banana_image_1,banana_image_2,banana_image_3,banana_image_4],
    description: [
      "Sweet and ripe",
      "High in potassium",
  ...
  },
  {
    ...
    price: 150,
    offerPrice: 140,
    image: [mango_image_1,mango_image_2,mango_image_3,mango_image_4],
    description: [
      "Sweet and flavorful",
  ...
  },
  {
    ...
    price: 70,
    offerPrice: 65,
    image: [grapes_image_1,grapes_image_2,grapes_image_3,grapes_image_4],
    description: [
      "Fresh and juicy",
  ...
  // Dairy
  {
    ...
    price: 60,
    offerPrice: 55,
    image: [amul_milk_image_1,amul_milk_image_2,amul_milk_image_3,amul_milk_image_4],
    description: [
      "Pure and fresh",
      "Rich in calcium",
  ...
  // Drinks
  {
    ...
    price: 80,
    offerPrice: 75,
    image: [coca_cola_image_1,coca_cola_image_2,coca_cola_image_3,coca_cola_image_4],
    description: [
  ...
  },
  {
    ...
    price: 78,
    offerPrice: 73,
    image: [pepsi_image_1,pepsi_image_2,pepsi_image_3,pepsi_image_4],
    description: [
  ...
  },
  {
    ...
    price: 79,
    offerPrice: 74,
    image: [sprite_image_1,sprite_image_2,sprite_image_3,sprite_image_4],
    description: [
  ...
  },
  {
    ...
    price: 77,
    offerPrice: 72,
    image: [fanta_image_1,fanta_image_2,fanta_image_3,fanta_image_4],
    description: [
      "Sweet and fizzy",
  ...
  },
  {
    ...
    price: 76,
    offerPrice: 71,
    image: [seven_up_image_1,seven_up_image_2,seven_up_image_3,seven_up_image_4],
    description: [
